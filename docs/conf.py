# -*- coding: utf-8 -*-
#
# Bond documentation build configuration file, created by
...
project = u'Bond'
copyright = u'2015, George Necula, Erik Krogen'
author = u'George Necula, Erik Krogen'
...
html_title = "Bond - Testing with Spies and Mocks"
...
latex_documents = [
  (master_doc, 'Bond.tex', u'Bond Documentation',
   u'George Necula, Erik Krogen', 'manual'),
]
...
man_pages = [
    (master_doc, 'bond', u'Bond Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Bond', u'Bond Documentation',
   author, 'Bond', 'One line description of project.',
   'Miscellaneous'),
]
